...
module.exports = {
  ...
  addonLogo: process.env.ADDON_LOGO || 'https://i.postimg.cc/VLwTjB6d/rkp-favourites-logo.png',
  addonBackground: process.env.ADDON_BACKGROUND || 'https://i.postimg.cc/2SpsXR25/rkp-favourites-bg.png',
